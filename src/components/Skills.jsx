      ...
      <div className="container-custom">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
            I'm building my expertise in frontend development with a focus on React, modern CSS, and
            user experience design. Here's a breakdown of my current skills and learning progress.
          </p>
        </div>
        ...
        <div
          ...
          className={`grid lg:grid-cols-3 gap-8 transition-all duration-1000 ${
            hasBeenInViewport ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
          }`}
        >
        ...
        <div className="mt-16">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {additionalSkills.map((skill, index) => (
              <div
                key={index}
                className="bg-white dark:bg-dark-800 rounded-lg p-4 text-center shadow-md hover:shadow-lg transition-shadow duration-200"
              >
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white dark:bg-dark-800 rounded-xl p-6 shadow-lg text-center">
              ...
              <h4 className="font-semibold text-gray-900 dark:text-white mb-2">
                NAVTTC Certified Course in Web Development
              </h4>
              <p className="text-sm text-gray-600 dark:text-gray-400">
                IT Specialist – HTML5 Application Development (Certiport)
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-dark-800 rounded-xl p-6 shadow-lg text-center">
              ...
              <h4 className="font-semibold text-gray-900 dark:text-white mb-2">
                CSS, JavaScript, PHP and Python Programming – All in One
              </h4>
              <p className="text-sm text-gray-600 dark:text-gray-400">Udemy Certified</p>
            </div>
            ...
            <div className="bg-white dark:bg-dark-800 rounded-xl p-6 shadow-lg text-center">
              ...
              <h4 className="font-semibold text-gray-900 dark:text-white mb-2">
                Zero to Hero JavaScript Course
              </h4>
              <p className="text-sm text-gray-600 dark:text-gray-400">The Cyber Champs Certified</p>
            </div>
          </div>
        </div>
      </div>
